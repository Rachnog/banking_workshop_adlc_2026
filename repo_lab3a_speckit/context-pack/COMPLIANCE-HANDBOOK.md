...
> (e.g. large-value transaction reporting); all specifics are simplified or invented for
> this workshop. Not legal guidance. No real bank's policy appears here.
...
The **screening thresholds** used for inline flagging (internal risk appetite, see
`docs/SPEC-threshold-screening.md`) are NOT the statutory LVTR threshold in §2.

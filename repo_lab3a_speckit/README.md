...
This catch-up repo ships the card for the lab it starts at — [`docs/task-cards/LAB-3a-speckit.md`](docs/task-cards/LAB-3a-speckit.md) — with prompts, success checks, and stretch goals. The Lab 3a reference spec is [`docs/SPEC-threshold-screening.md`](docs/SPEC-threshold-screening.md).

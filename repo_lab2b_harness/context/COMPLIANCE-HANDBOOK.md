...
> this document. Not legal guidance. No real bank's policy appears here.
...
The **screening thresholds** used for inline flagging (internal risk appetite, defined in the screening spec) are NOT the statutory LVTR threshold in §2.

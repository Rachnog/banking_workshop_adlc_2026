...
All labs live in [`docs/task-cards/`](docs/task-cards/) — one card per lab, with prompts, success checks, and stretch goals. The Lab 3a spec is [`docs/SPEC-threshold-screening.md`](docs/SPEC-threshold-screening.md).
